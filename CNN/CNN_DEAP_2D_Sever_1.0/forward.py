...
# 定义第一层的卷积核大小和个数
CONV1_SIZE = 4
CONV1_KERNEL_NUM = 2048
# 定义第二层的卷积核大小和个数
CONV2_SIZE = 4
CONV2_KERNEL_NUM = 1024
# 定义第三层的卷积核大小和个数
CONV3_SIZE = 4
...
def forward(x, train, regularizer):
    ...
    reshaped = tf.reshape(relu3, [pool_shape[0], nodes])  # 将pool2转换为一个batch的向量再传入后续的全连接
    ...
    fc1 = tf.nn.sigmoid(tf.matmul(reshaped, fc1_w) + fc1_b)
