...
class MNISTNetwork():
    ...
    def __init__(self):
        ...
        self.cl1 = CNN.ConvLayer(28, 28, 1, 5, 5, 6, 0, 1, Activators.SigmoidActivator(),
        ...
        # 初始化构造卷积层：输入宽度、输入高度、通道数、滤波器宽度、滤波器高度、滤波器数目、补零数目、步长、激活器、学习速率
        self.cl2 = CNN.ConvLayer(12, 12, 6, 5, 5, 12, 0, 1, Activators.SigmoidActivator(),
...
if __name__ == '__main__':
    ...
    # =============================加载数据集=============================
    train_data_set, train_labels = MNIST.get_training_data_set(600,
